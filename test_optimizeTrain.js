...
(async () => {
  const cmdSeq = [
    '/customize/trainServer/stop', //停止trainServer
    '/customize/detectServer/stop',//停止detectServer
    '/customize/detectServer/start', //加载模型，再次启动detectServer
    '/customize/detectErrorsInLib',  //检测图片库中的错误, 如果有入库错误，请进入图片管理，手动删除错误图片
    '/customize/trainServer/start', //再次启动trainServer
    '/customize/train/start', //再次启动训练
  ];
